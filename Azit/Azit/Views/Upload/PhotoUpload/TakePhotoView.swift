...
struct TakePhotoView: View {
    ...
    var body: some View {
        VStack {
            ...
            // PhotoReviewView 전환
            NavigationLink(
                destination: UploadPhotoStoryView(firstNaviLinkActive: $firstNaviLinkActive,isMainDisplay: $isMainDisplay , isMyModalPresented: $isMyModalPresented, isPhotoTaken: $isPhotoTaken, image: cameraService.capturedImage),
